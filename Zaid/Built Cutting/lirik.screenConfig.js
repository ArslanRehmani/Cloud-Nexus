...
define(['N/ui/serverWidget', 'N/search'], function (serverWidget, search) {
  ...
  return {
    clientScriptModulePath: './lirik.cs.beltcuttingscreen.js',
    // clientScriptFileId: 12819,
    form: {
      title: 'Belt Cutting Process',
      hideNavBar: false
    },
    buttons: [
    ...
    sublists: [{
      ...
      filters: {
        default: [
          ...
          ["type", "anyof", "InvtPart"],
          "AND",
          ["inventorylocation.custrecord_dnd_belt_cutting", "is", "T"],
          "AND",
        ...
        request: [
          ...
          { id: 'form_fld_item_location', searchField: 'inventorynumber.location', searchOperator: search.Operator.ANYOF },
    ...
    summary: {
      scriptId: 'customscript_lirik_ss_beltcuttingsummscr',
      scriptDeployId: 'customdeploy_lirik_ss_beltcuttingsummscr',
      id: 'items_accordion',
