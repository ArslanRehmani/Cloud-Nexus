function createCustomOrder(params) {
	...
	try
	{
        ...
        var segNumber = params.getParameter("cc-cvc");
		...
		if(paymentmethod!="9")
		{
			...
			customer.setCurrentLineItemValue('creditcards', 'ccname', firstName);
        ...
        */     
		...
		if(paymentmethod == '9'){
          ...
          order.setFieldValue('chargeit','F');
        }	
        ...
        if(paymentmethod!="9")
			order.setFieldValue('ccname',firstName);
