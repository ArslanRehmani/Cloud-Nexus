...
STR_LOG_TITLE = "Calc Max Gift Transaction";

//**************************************************************
function calcMaxGift()
{
// Search for largest gift
...
if ( rec.getId() != null ) 
{
	var results = getMaxGift(rec.getId()) ; 
...
function getMaxGift(recID)
{
	...
	return getAllResults('transaction', 'customsearch_afmo_max_gift_tx', arrFilters, arrColumns);
