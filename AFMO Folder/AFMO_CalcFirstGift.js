...
STR_LOG_TITLE = "Calc First Gift Transaction";

//**************************************************************
function calcFirstGift()
{
// Search for first gift
...
if ( rec.getId() != null ) 
{
	var results = getFirstGift(rec.getId()) ; 
...
function getFirstGift(recID)
{
	...
	return getAllResults('transaction', 'customsearch_afmo_first_gift_tx', arrFilters, arrColumns);
